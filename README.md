...
- **Progress** — a quiet weekly status plus a minimal **Top Exercises** card (top 5
  most-logged exercises with PR weight + date, no clutter) and a subtle rotating
  training-quote footer, with
