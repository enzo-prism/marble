...
SNAPSHOT_GROUPS_FULL=(
  ...
  "MarbleSnapshotTests/StreakSnapshotTests/testStreakLoggedTodayAtBest"
  "MarbleSnapshotTests/StreakSnapshotTests/testStreakAliveFromYesterday"
  "MarbleSnapshotTests/StreakSnapshotTests/testStreakBroken"
  ...
  "MarbleSnapshotTests/SupplementsSnapshotTests/testSupplementTypeEditorWithCustomEmoji"
