...
asc-review:
	asc review status --app "$(ASC_APP)" --version "$(ASC_MARKETING_VERSION)" --platform "$(ASC_PLATFORM)" --output table
	asc review doctor --app "$(ASC_APP)" --version "$(ASC_MARKETING_VERSION)" --platform "$(ASC_PLATFORM)" --output table

asc-validate:
	asc validate --app "$(ASC_APP)" --version "$(ASC_MARKETING_VERSION)" --platform "$(ASC_PLATFORM)" --output table

asc-next-build:
	asc builds next-build-number --app "$(ASC_APP)" --version "$(ASC_MARKETING_VERSION)" --platform "$(ASC_PLATFORM)" --output table
